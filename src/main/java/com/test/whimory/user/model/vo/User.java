...
public class User implements java.io.Serializable {
	...
	public User(String user_id, String user_pwd, String user_name, String gender, Date birth, String phone, String email,
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_pwd=" + user_pwd + ", user_name=" + user_name + ", gender=" + gender
