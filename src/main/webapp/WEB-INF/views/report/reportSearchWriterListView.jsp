...
function resetList(){
	location.href="${ pageContext.servletContext.contextPath }/rplist.do";
}
</script>
...
<div style="text-align:center;">
	...
	<c:if test="${ currentPage > 1 }">
      <c:url var="ubl" value="/rpwriter.do">
	...
	<c:url var="ubl2" value="/rpwriter.do">
	...
	<c:forEach var="p" begin="${ startPage }" end="${ endPage }">
		...
		<c:if test="${ p != currentPage }">
			<c:url var="rplist" value="/rpwriter.do">
	...
	<c:url var="ubl4" value="/rpwriter.do">
